    ...
    <div class="page">
      <div class="container">
        <div class="form-header">
          <p class="eyebrow">Plan gratuit · 2 / 3 fiches ce mois</p>
          <h1>Nouvelle fiche</h1>
          <p class="subtitle">Personnalisée pour votre enfant et alignée sur le programme FWB.</p>
        </div>
          ...
          <div class="form-card">
            ...
            >
              @if (loading) {
                ...
                Préparation de la fiche de {{ childName }}…
              } @else {
                Générer la fiche
              }
            </button>
              ...
              <div class="preview-body">
                ...
                @if (!selectedSubject || !selectedTheme) {
                  <div class="preview-placeholder">
                    <p>Sélectionnez une matière et un thème pour voir l'aperçu de la fiche.</p>
                  </div>
                }
              </div>
...
export class GeneratorForm2Component {
  levels = LEVELS;
  childName = '';
  selectedLevel = '';
